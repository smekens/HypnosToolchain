...
SYSROOT=$HYPNOS_TOOLCHAIN/targets/android/sysroot

PROGRAM_PREFIX=hypnos-android-
...
patch -p0 < ../patches/android/binutils-$binutils_version.patch
patch -p0 < ../patches/android/gcc-$gcc_version.patch
